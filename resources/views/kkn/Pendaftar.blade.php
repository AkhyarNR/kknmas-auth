...
<script type="text/x-kendo-template" id="template">
    <div class="k-edit-label"><label for="Nama_Penanggung_Jawab">NIM :</label></div>
    ...
    <div class="k-edit-label"><label for="Nama_Penanggung_Jawab">Nama :</label></div>
    <div data-container-for="Nama_Penanggung_Jawab" class="k-edit-field" >
        <input name="Nama_Penanggung_Jawab" type="text" class="k-input k-textbox input-width-modal" style="margin-left:10px" required validationMessage="Field tidak boleh kosong">
    </div>
    ...
    <div class="k-edit-label"><label for="Nama_Penanggung_Jawab">No Hp :</label></div>
    <div data-container-for="Nama_Penanggung_Jawab" class="k-edit-field" >
        <input name="Nama_Penanggung_Jawab" type="text" class="k-input k-textbox input-width-modal" style="margin-left:10px" required validationMessage="Field tidak boleh kosong">
    </div>
</script>
...
<script type="text/x-kendo-template" id="toolbarTemplate">
    ...
    <a id="exportpdf" class="k-button k-button-icontext" href='{{asset("/cetak_listpasien")}}' target='_blank'><span class="k-icon k-i-excel"></span>Import Excel</a>
...
$(function(){
  ...
  $('#grid').kendoGrid({
    ...
    columns:[
      {field: 'Alamat', title: 'Periode KKN'},
      {field: 'Alamat', title: 'NIM'},
      {field: 'Pasien_Id', title: 'Nama Peserta',template:'#: data.Nama#'},
      {field: 'Nama_Penanggung_Jawab', title: 'Email'},
