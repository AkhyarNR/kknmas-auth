...
<script type="text/x-kendo-template" id="template">
    <div class="k-edit-label"><label for="Nama_Penanggung_Jawab">Periode</label></div>
    ...
    <div class="k-edit-label"><label for="Jenis_Kelamin_Id">Host</label></div>
    ...
    <div class="k-edit-label"><label for="Tanggal_Lahir_Pj">Pendaftaran Dibuka</label></div>
    ...
    <div class="k-edit-label"><label for="Tanggal_Lahir_Pj">Pendaftaran Ditutup</label></div>
    <div data-container-for="Tanggal_Lahir_Pj" class="k-edit-field" >
        <input name="Tanggal_Lahir_Pj" class="input-width-modal" style="margin-left:10px" required validationMessage="Field tidak boleh kosong">
    </div>
    <div class="k-edit-label"><label for="Tanggal_Lahir_Pj">Tanggal Mulai</label></div>
    <div data-container-for="Tanggal_Lahir_Pj" class="k-edit-field" >
        <input name="Tanggal_Lahir_Pj" class="input-width-modal" style="margin-left:10px" required validationMessage="Field tidak boleh kosong">
    </div>
    <div class="k-edit-label"><label for="Tanggal_Lahir_Pj">Tanggal Selesai</label></div>
    <div data-container-for="Tanggal_Lahir_Pj" class="k-edit-field" >
        <input name="Tanggal_Lahir_Pj" class="input-width-modal" style="margin-left:10px" required validationMessage="Field tidak boleh kosong">
    </div>
    <div class="k-edit-label"><label for="Nama_Penanggung_Jawab">Kuota</label></div>
    <div data-container-for="Nama_Penanggung_Jawab" class="k-edit-field" >
        <input name="Nama_Penanggung_Jawab" type="text" class="k-input k-textbox input-width-modal" style="margin-left:10px" required validationMessage="Field tidak boleh kosong">
    </div>
</script>
  ...
  $('#grid').kendoGrid({
    ...
    columns:[
      {field: 'Agama', title: 'No'},
        {field: 'Agama', title: 'Periode'},
        {field: 'Agama', title: 'Host'},
        {field: 'Agama', title: 'Tanggal Pendaftaran'},
        {field: 'Agama', title: 'Tanggal Pelaksanaan'},
        {field: 'Agama', title: 'Kuota'},
