  ...
  $(function(){
    ...
    $('#grid').kendoGrid({
      ...
      columns:[
        ...
        {field: 'Agama', title: 'S_Pj'},
        {field: 'Agama', title: 'S_Pd'},
        {field: 'Agama', title: 'M_Pj'},
        {field: 'Agama', title: 'M_Pd'},
        {field: 'Agama', title: 'L_Pj'},
        {field: 'Agama', title: 'L_Pd'},
        {field: 'Agama', title: 'XL_Pj'},
        {field: 'Agama', title: 'XL_Pd'},
        {field: 'Agama', title: 'XXL_Pj'},
        {field: 'Agama', title: 'XXL_Pd'},
        {field: 'Agama', title: 'XXXL_Pj'},
        {field: 'Agama', title: 'XXXL_Pd'},
        ],
      pageable: true,
      editable: 'inline'
      // edit : function(e) {
