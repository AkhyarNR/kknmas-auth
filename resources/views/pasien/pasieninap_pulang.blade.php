    ...
    <div class="col-md-12 col-sm-12 ">
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <form method="POST" action="{{ url('/pasienkamar_inap/'.$pasieninap->Pasien_Rawat_Inap_Id) }}" id="demo-form2" name="demo-form2" data-parsley-validate class="form-horizontal form-label-left" accept-charset="UTF-8">
            {{ method_field('PUT') }}
            {{ csrf_field() }}
            ...
            <div class="item form-group {{ $errors->has('Pasien_Penanggung_jawab_Id') ? 'has-error' : ''}}">
              <label for="Penanggungjawab_Id" class="col-form-label col-md-3 col-sm-3 label-align">Penanggung Jawab <span class="required">*</span></label>
              <div class="col-md-6 col-sm-6 ">
                <select id="Penanggungjawab_Id" class="form-control js-example-basic-single" name="Penanggungjawab_Id" disabled="disabled">
            ...
            <div class="item form-group {{ $errors->has('Tanggal_Keluar') ? 'has-error' : ''}}">
              ...
              <div class="col-md-6 col-sm-6 ">
                <input id="Tanggal_Keluar" class="date-picker form-control" type="date" name="Tanggal_Keluar">
                {!! $errors->first('Tanggal_Keluar', '<p class="help-block">:message</p>') !!}
              </div>
            </div>
            <div class="item form-group {{ $errors->has('Jam_Keluar') ? 'has-error' : ''}}">
              <label for="Jam_Keluar" class="col-form-label col-md-3 col-sm-3 label-align">Jam Keluar</label>
            ...
            <div class="item form-group {{ $errors->has('Lama') ? 'has-error' : ''}}">
              ...
              <div class="col-md-6 col-sm-6 ">
                <input id="Lama" class="form-control" value="{{ isset($interval) ? $interval : '' }}" type="text" name="Lama" readonly="">
              </div>
            </div>
            <div class="item form-group {{ $errors->has('Total_Biaya') ? 'has-error' : ''}}">
              ...
              <div class="col-md-6 col-sm-6 ">
                <input id="Total_Biaya" class="form-control" value="{{ $total }}" type="number" name="Lama" readonly="">
              </div>
            </div>
            <div class="item form-group {{ $errors->has('Status_Pulang_Id') ? 'has-error' : ''}}">
              ...
              <div class="col-md-6 col-sm-6 ">
                 <select id="Status_Pulang_Id" class="form-control js-example-basic-single" name="Status_Pulang_Id">
