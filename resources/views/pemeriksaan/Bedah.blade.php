...
<div class="right_col" role="main">
    <div class="">
        ...
        <form id="msform" action="{{url('pemeriksaan/bedah/createperiksa')}}" method="POST">
            <!-- progressbar -->
            <ul id="progressbar">
...
<script>
    ...
    $.ajax({
      ...
      success : function(){
            window.open('{{ url("pemeriksaan/polibedah") }}/','_self');
        }
    });
}
                  ...
                  if (isAllValid) {
                      ...
                      $.ajax({
                        headers: {
                          ...
                          data : form,
                          type: "POST",
                          url: "{{ url('pemeriksaan/bedah/createperiksa') }}",
                          success: function (d) {
                              //check is successfully save to database
                              if (d.status == 1) {
                                  //will send status from server side
