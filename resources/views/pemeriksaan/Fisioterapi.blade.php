...
<div class="right_col" role="main">
    <div class="">
        ...
        <form id="msform" action="{{url('pemeriksaan/fisio/createperiksa')}}" method="POST">
            <!-- progressbar -->
            <ul id="progressbar">
...
<script>
    ...
    $.ajax({
      ...
      success : function(){
            window.open('{{ url("pemeriksaan/polifisio") }}/','_self');
        }
    });
}
...
$(document).ready(function(){
    ...
    //                     data : form,
    //                     type: "POST",
    //                     url: "{{ url('pemeriksaan/fisio/createperiksa') }}",
    //                     success: function (d) {
