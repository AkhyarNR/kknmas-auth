...
<div class="right_col" role="main">
    <div class="">
        ...
        <form id="msform" action="{{url('pemeriksaan/igd/createperiksa')}}" method="POST">
            <!-- progressbar -->
            <ul id="progressbar">
            ...
            <fieldset>  
                ...
                <div class="form-card">              
                   ...
                   <button type="button" name="batal1" onclick="batal()" class="batal action-button-previous">Batal</button>
...
<script>
    ...
    function batal(id) {
        window.open('{{ url("pemeriksaan/igd") }}/','_self');
    }
                  ...
                  if (isAllValid) {
                      ...
                      $.ajax({
                        headers: {
                          ...
                          data : form,
                          type: "POST",
                          url: "{{ url('pemeriksaan/igd/createperiksa') }}",
                          success: function (d) {
                              //check is successfully save to database
                              if (d.status == 1) {
                                  //will send status from server side
