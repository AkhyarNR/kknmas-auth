    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Poli Kulit dan Kelamin</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">

        <form id="msform" action="{{url('pemeriksaan/kkl/createperiksa')}}" method="POST">
            <!-- progressbar -->
            <ul id="progressbar">
            ...
            <fieldset>  
                <br>
                <div class="form-card">              
                    @include('pemeriksaan.Form_KulitKelamin')
                </div>
...
<script>
    ...
    $.ajax({
      ...
      success : function(){
            window.open('{{ url("pemeriksaan/polikkl") }}/','_self');
        }
    });
}
                  ...
                  if (isAllValid) {
                      ...
                      $.ajax({
                        headers: {
                          ...
                          data : form,
                          type: "POST",
                          url: "{{ url('pemeriksaan/kkl/createperiksa') }}",
                          success: function (d) {
                              //check is successfully save to database
                              if (d.status == 1) {
                                  //will send status from server side
