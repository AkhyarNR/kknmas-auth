    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Lab Patologi Klinik</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">

                        <form id="msform" action="{{url('pemeriksaan/patologiklinik/createperiksa')}}" method="POST">
                            <!-- progressbar -->
                            <ul id="progressbar">
                            ...
                            <fieldset>  
                                <br>
                                <div class="form-card">              
                                    @include('pemeriksaan.labpatologiklinik.Form_DetailLab')
                                </div>
                            ...
                            <fieldset>  
                                <br>
                                <div class="form-card">              
                                    @include('pemeriksaan.labpatologiklinik.Form_PatologiKlinik')
                                </div>
...
<script>
    ...
    $.ajax({
      ...
      success : function(){
            window.open('{{ url("pemeriksaan/labpatologiklinik") }}/','_self');
        }
    });
}
