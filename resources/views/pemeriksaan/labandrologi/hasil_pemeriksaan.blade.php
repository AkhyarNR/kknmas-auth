  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <h3>Hasil Pemeriksaan Lab Andrologi</h3>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <div id="grid"></div>
        ...
        dataSource: {
          transport:{
            ...
            options.data.endDate = $("#tglSelesai").val();
              $.ajax({
                url : '{{ url('pemeriksaan/labandrologi/hasil_pemeriksaan/read') }}',
                type: 'GET',
                dataType: 'json',
                data: options.data,
            ...
            $.ajax({
              url : '{{ url('pemeriksaan/labandrologi/hasil_pemeriksaan/Hapus') }}',
              dataType:'json',
              type:'GET',
              data:options.data,
              success:function(res){
                      ...
                      actions: [
                          {
                              ...
                              action: function (e) {
                                  ...
                                  $.ajax({
                                      ...
                                      url: "{{ asset('pemeriksaan/labandrologi/hasil_pemeriksaan/Hapus') }}",
                                      type: "GET",
                                      data: id,
                                      dataType: "json",
                                      complete: function (e) {
              ...
              dataSource: {
                  transport:{
                    read : function(options) {
                      ...
                      $.ajax({
                        url : '{{ url('pemeriksaan/labandrologi/hasil_pemeriksaan/DetailHasil') }}',
                        type: 'GET',
              ...
              dataSource: {
                  transport:{
                    read : function(options) {
                      ...
                      $.ajax({
                        url : '{{ url('pemeriksaan/labandrologi/hasil_pemeriksaan/DetailProsedur') }}',
                        type: 'GET',
                        data:{Pemeriksaan_Id : Pemeriksaan_Id},
                        dataType: 'json',
                        success: function(res) {
                ...
                transport:{
                  ...
                  create: function(options) {
                    ...
                    $.ajax({
                      ...
                      url : '{{ url('pemeriksaan/labandrologi/hasil_pemeriksaan/updatehasil') }}',
                      type: 'POST',
                      dataType: 'json',
                ...
                $.ajax({
                      ...
                      success: function(res) {
                        ...
                        $.each(res['data'], function(q,value){
                          ...
                          if(value.Indikator_Pemeriksaan_Id == 81){
                            aglutinasi = value.Indikator_Nilai_Id;
                          }
                          if(value.Indikator_Pemeriksaan_Id == 82){
                            agregasi = value.Indikator_Nilai_Id;
                          }
                          if(value.Indikator_Pemeriksaan_Id == 83){
                            alh = value.Indikator_Nilai_Id;
                          }
                        ...
                        $('#IndikatorPemeriksaan81').kendoDropDownList({
                        ...
                        $('#IndikatorPemeriksaan81').data('kendoDropDownList').value(aglutinasi);

                        $('#IndikatorPemeriksaan82').kendoDropDownList({
                        ...
                        $('#IndikatorPemeriksaan82').data('kendoDropDownList').value(agregasi);

                        $('#IndikatorPemeriksaan83').kendoDropDownList({
                        ...
                        $('#IndikatorPemeriksaan83').data('kendoDropDownList').value(alh);
