      ...
      dataSource: {
        transport:{
          read : function(options) {
            ...
            $.ajax({
              url : '{{ url('pemeriksaan/labandrologi/read') }}',
              type: 'GET',
              dataType: 'json',
              data: options.data,
                    ...
                    actions: [
                        {
                            ...
                            action: function (e) {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{ asset('pemeriksaan/labandrologi/hapus') }}",
                                    type: "GET",
                                    data: id,
                                    dataType: "json",
                                    complete: function (e) {
    ...
    e.preventDefault();
        ...
        var id = {Antrian_Pasien_Id: data.Antrian_Pasien_Id, Pasien_Id : data.Pasien_Id, Work_Unit_Id : data.Work_Unit_Id,Dokter_Id : data.Dokter_Id, Shift_Id : data.Shift_Id, Pasien_Lab_Id : data.Pasien_Lab_Id};
            ...
            $.ajax({
                ...
                url: "{{ asset('pemeriksaan/labandrologi/create') }}",
                type: "POST",
                data: id,
                dataType: "json",
                success : function(res){
                          window.open('{{ url("pemeriksaan/andrologilab") }}/'+res,'_self');
                  }
              });
  }
    ...
    e.preventDefault();
        ...
        var id = {Antrian_Pasien_Id: data.Antrian_Pasien_Id, Pasien_Id : data.Pasien_Id, Work_Unit_Id : data.Work_Unit_Id,Dokter_Id : data.Dokter_Id, Shift_Id : data.Shift_Id};
            ...
            $.ajax({
                ...
                url: "{{ asset('pemeriksaan/labandrologi/skip') }}",
                type: "POST",
                data: id,
                dataType: "json",
                success : function(res){
