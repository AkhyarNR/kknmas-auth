  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <h3>Data Pasien laboratorium</h3>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <div id="grid"></div>
      ...
      dataSource: {
        transport:{
          read : function(options) {
            ...
            $.ajax({
              url : '{{ url('pemeriksaan/laboratorium/read') }}',
              type: 'GET',
              dataType: 'json',
              data: options.data,
          ...
          create : function(options) {
            $.ajax({
              ...
              url : '{{ url('pemeriksaan/laboratorium/create') }}',
              type: 'POST',
              dataType: 'json',
              data: options.data,
              success: function(res) {
         ...
         $("#Pasien_Id").kendoDropDownList({
            ...
            dataSource:{
                transport:{
                    read:{
                        type: "GET",
                        url: "{{url('pemeriksaan/laboratorium/getPasien')}}",
                        dataType: "json"
                    }
                }
            },
                    ...
                    actions: [
                        {
                            ...
                            action: function (e) {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{ asset('pemeriksaan/laboratorium/hapus') }}",
                                    type: "GET",
                                    data: id,
                                    dataType: "json",
                      complete: function (e) {
      ...
      var RiwayatPemeriksaan = new kendo.data.DataSource({
        transport:{
          read: function(options){
            ...
            $.ajax({
              url: '{{ url('pemeriksaan/laboratorium/readdetail') }}',
              type: "GET",
