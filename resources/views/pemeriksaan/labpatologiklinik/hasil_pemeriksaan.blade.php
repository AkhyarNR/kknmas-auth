  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <h3>Hasil Pemeriksaan Lab.Patologi Klinik</h3>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <div id="grid"></div>
        ...
        dataSource: {
          transport:{
            ...
            options.data.endDate = $("#tglSelesai").val();
              $.ajax({
                url : '{{ url('pemeriksaan/labpatologiklinik/hasil_pemeriksaan/read') }}',
                type: 'GET',
                dataType: 'json',
                data: options.data,
            ...
            $.ajax({
              url : '{{ url('pemeriksaan/labpatologiklinik/hasil_pemeriksaan/Hapus') }}',
              dataType:'json',
              type:'GET',
              data:options.data,
              success:function(res){
                      ...
                      actions: [
                          {
                              ...
                              action: function (e) {
                                  ...
                                  $.ajax({
                                      ...
                                      url: "{{ asset('pemeriksaan/labpatologiklinik/hasil_pemeriksaan/Hapus') }}",
                                      type: "GET",
                                      data: id,
                                      dataType: "json",
                                      complete: function (e) {
              ...
              dataSource: {
                  transport:{
                    read : function(options) {
                      ...
                      $.ajax({
                        url : '{{ url('pemeriksaan/labpatologiklinik/hasil_pemeriksaan/DetailHasil') }}',
                        type: 'GET',
              ...
              dataSource: {
                  transport:{
                    read : function(options) {
                      ...
                      $.ajax({
                        url : '{{ url('pemeriksaan/labpatologiklinik/hasil_pemeriksaan/DetailProsedur') }}',
                        type: 'GET',
                        data:{Pemeriksaan_Id : Pemeriksaan_Id},
                        dataType: 'json',
                        success: function(res) {
                ...
                transport:{
                  ...
                  create: function(options) {
                    ...
                    $.ajax({
                      ...
                      url : '{{ url('pemeriksaan/labpatologiklinik/hasil_pemeriksaan/updatehasil') }}',
                      type: 'POST',
                      dataType: 'json',
                ...
                $.ajax({
                      ...
                      success: function(res) {
                        ...
                        $.each(res['data'], function(q,value){
                          ...
                          if(value.Indikator_Pemeriksaan_Id == 58){
                            goldarah = value.Indikator_Nilai_Id;
                          }
                          if(value.Indikator_Pemeriksaan_Id == 59){
                            Rhesus = value.Indikator_Nilai_Id;
                          }
                          if(value.Indikator_Pemeriksaan_Id == 60){
                            HBs = value.Indikator_Nilai_Id;
                          }
                        ...
                        $('#IndikatorPemeriksaan61').kendoDatePicker({
                          format: "dd/MM/yyyy"
                        });
                        $('#IndikatorPemeriksaan62,#IndikatorPemeriksaan63,#IndikatorPemeriksaan64').kendoTimePicker({
                          format: "HH:mm tt"
                        });

                        $('#IndikatorPemeriksaan58').kendoDropDownList({
                          ...
                          $('#IndikatorPemeriksaan58').data('kendoDropDownList').value(goldarah);

                          $('#IndikatorPemeriksaan59').kendoDropDownList({
                          ...
                          $('#IndikatorPemeriksaan59').data('kendoDropDownList').value(Rhesus);

                          $('#IndikatorPemeriksaan60').kendoDropDownList({
                           ...
                           $('#IndikatorPemeriksaan60').data('kendoDropDownList').value(HBs);
