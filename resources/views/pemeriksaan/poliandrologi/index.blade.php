...
<script>
      ...
      dataSource: {
        transport:{
          read : function(options) {
            ...
            $.ajax({
              url : '{{ url('pemeriksaan/poliandrologi/read') }}',
              type: 'GET',
              dataType: 'json',
              data: options.data,
                    ...
                    actions: [
                        {
                            ...
                            action: function (e) {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{ asset('pemeriksaan/poliandrologi/hapus') }}",
                                    type: "GET",
                                    data: id,
                                    dataType: "json",
                                    complete: function (e) {
    ...
    e.preventDefault();
        ...
        var id = {Antrian_Pasien_Id: data.Antrian_Pasien_Id, Pasien_Id : data.Pasien_Id, Work_Unit_Id : data.Work_Unit_Id,Dokter_Id : data.Dokter_Id, Shift_Id : data.Shift_Id, Pasien_Rawat_Jalan_Id : data.Pasien_Rawat_Jalan_Id};
            ...
            $.ajax({
                ...
                url: "{{ asset('pemeriksaan/poliandrologi/create') }}",
                type: "POST",
                data: id,
                dataType: "json",
                success : function(res){
                          window.open('{{ url("pemeriksaan/poliandrologi/pra_andrologi") }}/'+res,'_self');
                  }
              });
  }
    ...
    e.preventDefault();
        ...
        var id = {Pemeriksaan_Id: data.Pemeriksaan_Id, Employee : data.Employee_Id, Pasien_Id : data.Pasien_Id, Pasien_Rawat_Jalan_Id : data.Pasien_Rawat_Jalan_Id};
            ...
            $.ajax({
                ...
                url: "{{ asset('pemeriksaan/poliandrologi/update') }}",
                type: "POST",
                data: id,
                dataType: "json",
                success : function(res){
                          window.open('{{ url("pemeriksaan/andrologi") }}/'+res,'_self');
                  }
              });
  }
    ...
    e.preventDefault();
        ...
        var id = {Antrian_Pasien_Id: data.Antrian_Pasien_Id, Pasien_Id : data.Pasien_Id, Work_Unit_Id : data.Work_Unit_Id,Dokter_Id : data.Dokter_Id, Shift_Id : data.Shift_Id};
            ...
            $.ajax({
                ...
                url: "{{ asset('pemeriksaan/poliandrologi/skip') }}",
                type: "POST",
                data: id,
                dataType: "json",
                success : function(res){
  ...
  function detailInit(e) {
      ...
      $.ajax({
              url : '{{ url('pemeriksaan/poliandrologi/alergipasien') }}',
              dataType:'json',
              type:'GET',
      ...
      $.ajax({
              url : '{{ url('pemeriksaan/poliandrologi/asuransipasien') }}',
              dataType:'json',
              type:'GET',
              data:{'Pasien_Id' : data.Pasien_Id},
              success:function(res){
