  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <h3>Antrian Poli Kulit dan Kelamin</h3>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <div id="grid"></div>
...
<script>
      ...
      dataSource: {
        transport:{
          read : function(options) {
            ...
            $.ajax({
              url : '{{ url('pemeriksaan/polikkl/read') }}',
              type: 'GET',
              dataType: 'json',
              data: options.data,
                    ...
                    actions: [
                        {
                            ...
                            action: function (e) {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{ asset('pemeriksaan/polikkl/hapus') }}",
                                    type: "GET",
                                    data: id,
                                    dataType: "json",
                                    complete: function (e) {
    ...
    e.preventDefault();
        ...
        var id = {Antrian_Pasien_Id: data.Antrian_Pasien_Id, Pasien_Id : data.Pasien_Id, Work_Unit_Id : data.Work_Unit_Id,Dokter_Id : data.Dokter_Id, Shift_Id : data.Shift_Id, Pasien_Rawat_Jalan_Id : data.Pasien_Rawat_Jalan_Id};
            ...
            $.ajax({
                ...
                url: "{{ asset('pemeriksaan/polikkl/create') }}",
                type: "POST",
                data: id,
                dataType: "json",
                success : function(res){
                          window.open('{{ url("pemeriksaan/polikkl/pra_kkl") }}/'+res,'_self');
                  }
              });
  }
    ...
    e.preventDefault();
        ...
        var id = {Pemeriksaan_Id: data.Pemeriksaan_Id, Employee : data.Employee_Id, Pasien_Id : data.Pasien_Id, Pasien_Rawat_Jalan_Id : data.Pasien_Rawat_Jalan_Id};
            ...
            $.ajax({
                ...
                url: "{{ asset('pemeriksaan/polikkl/update') }}",
                type: "POST",
                data: id,
                dataType: "json",
                success : function(res){
                          window.open('{{ url("pemeriksaan/kkl") }}/'+res,'_self');
                  }
              });
  }
    ...
    e.preventDefault();
        ...
        var id = {Antrian_Pasien_Id: data.Antrian_Pasien_Id, Pasien_Id : data.Pasien_Id, Work_Unit_Id : data.Work_Unit_Id,Dokter_Id : data.Dokter_Id, Shift_Id : data.Shift_Id};
            ...
            $.ajax({
                ...
                url: "{{ asset('pemeriksaan/polikkl/skip') }}",
                type: "POST",
                data: id,
                dataType: "json",
                success : function(res){
  ...
  function detailInit(e) {
      ...
      $.ajax({
              url : '{{ url('pemeriksaan/polikkl/alergipasien') }}',
              dataType:'json',
              type:'GET',
      ...
      $.ajax({
              url : '{{ url('pemeriksaan/polikkl/asuransipasien') }}',
              dataType:'json',
              type:'GET',
              data:{'Pasien_Id' : data.Pasien_Id},
              success:function(res){
