  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <h3>Hasil Pemeriksaan Poli Penyakit Dalam</h3>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <div id="grid"></div>
        ...
        dataSource: {
          transport:{
            ...
            options.data.endDate = $("#tglSelesai").val();
              $.ajax({
                url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/read') }}',
                type: 'GET',
                dataType: 'json',
                data: options.data,
            ...
            $.ajax({
              url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/Hapus') }}',
              dataType:'json',
              type:'GET',
              data:options.data,
              success:function(res){
                      ...
                      actions: [
                          {
                              ...
                              action: function (e) {
                                  ...
                                  $.ajax({
                                      ...
                                      url: "{{ asset('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/Hapus') }}",
                                      type: "GET",
                                      data: id,
                                      dataType: "json",
                                      complete: function (e) {
              ...
              dataSource: {
                  transport:{
                    read : function(options) {
                      ...
                      $.ajax({
                        url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/DetailHasil') }}',
                        type: 'GET',
                    ...
                    create: function(options) {
                      ...
                      $.ajax({
                        ...
                        url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/updatehasil') }}',
                        type: 'POST',
                        dataType: 'json',
                        // data: {
                        //   "data" : options.data,
              ...
              dataSource: {
                  transport:{
                    read : function(options) {
                      ...
                      $.ajax({
                        url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/DetailDiagnosa') }}',
                        type: 'GET',
                        data:{Pemeriksaan_Id : Pemeriksaan_Id},
                        dataType: 'json',
                        success: function(res) {
              ...
              dataSource: {
                  transport:{
                    read : function(options) {
                      ...
                      $.ajax({
                        url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/DetailProsedur') }}',
                        type: 'GET',
                        data:{Pemeriksaan_Id : Pemeriksaan_Id},
                        dataType: 'json',
                        success: function(res) {
              ...
              dataSource: {
                  transport:{
                    read : function(options) {
                      ...
                      $.ajax({
                        url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/DetailTerapi') }}',
                        type: 'GET',
                        data:{Pemeriksaan_Id : Pemeriksaan_Id},
                        dataType: 'json',
                        success: function(res) {
            ...
            dataSource: {
                transport:{
                  read : function(options) {
                      ...
                      $.ajax({
                        url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/DetailResep') }}',
                        type: 'GET',
                        data:{Pemeriksaan_Id : Pemeriksaan_Id},
                        dataType: 'json',
                        success: function(res) {
              ...
              dataSource: {
                  transport:{
                    read : function(options) {
                      ...
                      $.ajax({
                        url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/DetailCatatan') }}',
                        type: 'GET',
                        data:{Pemeriksaan_Id : Pemeriksaan_Id},
                        dataType: 'json',
                        success: function(res) {
            ...
            dataSource: {
                transport:{
                  read : function(options) {
                      var Pemeriksaan_Id = data.Pemeriksaan_Id;
                      $.ajax({
                        url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/DetailRujukan') }}',
                        type: 'GET',
                        data:{Pemeriksaan_Id : Pemeriksaan_Id },
                        dataType: 'json',
                        success: function(res) {
                ...
                transport:{
                  ...
                  create: function(options) {
                    ...
                    $.ajax({
                      ...
                      url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/creatediagnosa') }}',
                      type: 'POST',
                      dataType: 'json',
                      data: options.data,
                      success: function(res) {
                  ...
                  update: function(options) {
                    ...
                    $.ajax({
                      ...
                      url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/updatediagnosa') }}',
                      type: 'POST',
                      dataType: 'json',
                      data: options.data,
                      success: function(res) {
                    ...
                    destroy: function(options){
                      $.ajax({
                        url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/deletediagnosa') }}',
                        dataType:'json',
                        type:'GET',
                        data:options.data,
                        success:function(res){
                ...
                transport:{
                  ...
                  create: function(options) {
                    ...
                    $.ajax({
                      ...
                      url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/createprosedur') }}',
                      type: 'POST',
                      dataType: 'json',
                      data: options.data,
                      success: function(res) {
                  ...
                  update: function(options) {
                    ...
                    $.ajax({
                      ...
                      url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/updateprosedur') }}',
                      type: 'POST',
                      dataType: 'json',
                      data: options.data,
                      success: function(res) {
                    ...
                    destroy: function(options){
                      $.ajax({
                        url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/deleteprosedur') }}',
                        dataType:'json',
                        type:'GET',
                        data:options.data,
                        success:function(res){
                ...
                transport:{
                  ...
                  create: function(options) {
                    ...
                    $.ajax({
                      ...
                      url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/createterapi') }}',
                      type: 'POST',
                      dataType: 'json',
                      data: options.data,
                      success: function(res) {
                  ...
                  update: function(options) {
                    ...
                    $.ajax({
                      ...
                      url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/updateterapi') }}',
                      type: 'POST',
                      dataType: 'json',
                      data: options.data,
                      success: function(res) {
                    ...
                    destroy: function(options){
                      $.ajax({
                        url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/deleteterapi') }}',
                        dataType:'json',
                        type:'GET',
                        data:options.data,
                        success:function(res){
              ...
              transport:{
                ...
                create : function(options) {
                  ...
                  $.ajax({
                    ...
                    url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/createresep') }}',
                    type: 'POST',
                    dataType: 'json',
                    data: options.data,
                    success: function(res) {
                ...
                update: function(options) {
                      ...
                      $.ajax({
                        ...
                        url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/updateresep') }}',
                        type: 'POST',
                        dataType: 'json',
                        data: options.data,
                        success: function(res) {
                ...
                destroy: function(options){
                  $.ajax({
                    url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/deleteresep') }}',
                    dataType:'json',
                    type:'GET',
                    data:options.data,
                    success:function(res){
                ...
                transport:{
                  ...
                  create: function(options) {
                    ...
                    $.ajax({
                      ...
                      url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/createcatatan') }}',
                      type: 'POST',
                      dataType: 'json',
                      data: options.data,
                      success: function(res) {
                  ...
                  update: function(options) {
                    ...
                    $.ajax({
                      ...
                      url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/updatecatatan') }}',
                      type: 'POST',
                      dataType: 'json',
                      data: options.data,
                      success: function(res) {
                    ...
                    destroy: function(options){
                      $.ajax({
                        url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/deletecatatan') }}',
                        dataType:'json',
                        type:'GET',
                        data:options.data,
                        success:function(res){
        ...
        $("#rujukan").kendoGrid({
          dataSource: {
              transport:{
                ...
                update: function(options) {
                  ...
                  options.data.Work_Unit_Id = $('input[name="Work_Unit_Id"]').data('kendoDropDownList').value();
                      ...
                      $.ajax({
                        ...
                        url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/updaterujukan') }}',
                        type: 'POST',
                        dataType: 'json',
                        data: options.data,
                        success: function(res) {
                ...
                destroy: function(options){
                  $.ajax({
                    url : '{{ url('pemeriksaan/polipenyakitdalam/hasil_pemeriksaan/deleterujukan') }}',
                    dataType:'json',
                    type:'GET',
                    data:options.data,
                    success:function(res){
