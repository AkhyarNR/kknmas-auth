...
<script>
      ...
      dataSource: {
        transport:{
          read : function(options) {
            ...
            $.ajax({
              url : '{{ url('pemeriksaan/poliumum/read') }}',
              type: 'GET',
              dataType: 'json',
              data: options.data,
                    ...
                    actions: [
                        {
                            ...
                            action: function (e) {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{ asset('pemeriksaan/poliumum/hapus') }}",
                                    type: "GET",
                                    data: id,
                                    dataType: "json",
                                    complete: function (e) {
    ...
    e.preventDefault();
        ...
        var id = {Antrian_Pasien_Id: data.Antrian_Pasien_Id, Pasien_Id : data.Pasien_Id, Work_Unit_Id : data.Work_Unit_Id,Dokter_Id : data.Dokter_Id, Shift_Id : data.Shift_Id, Pasien_Rawat_Jalan_Id : data.Pasien_Rawat_Jalan_Id};
            ...
            $.ajax({
                ...
                url: "{{ asset('pemeriksaan/poliumum/create') }}",
                type: "POST",
                data: id,
                dataType: "json",
                success : function(res){
                          window.open('{{ url("pemeriksaan/poliumum/pra_umum") }}/'+res,'_self');
                  }
              });
  }
    ...
    e.preventDefault();
        ...
        var id = {Pemeriksaan_Id: data.Pemeriksaan_Id, Employee : data.Employee_Id, Pasien_Id : data.Pasien_Id, Pasien_Rawat_Jalan_Id : data.Pasien_Rawat_Jalan_Id};
            ...
            $.ajax({
                ...
                url: "{{ asset('pemeriksaan/poliumum/update') }}",
                type: "POST",
                data: id,
                dataType: "json",
                success : function(res){
                          window.open('{{ url("pemeriksaan/umum") }}/'+res,'_self');
                  }
              });
  }
    ...
    e.preventDefault();
        ...
        var id = {Antrian_Pasien_Id: data.Antrian_Pasien_Id, Pasien_Id : data.Pasien_Id, Work_Unit_Id : data.Work_Unit_Id,Dokter_Id : data.Dokter_Id, Shift_Id : data.Shift_Id};
            ...
            $.ajax({
                ...
                url: "{{ asset('pemeriksaan/poliumum/skip') }}",
                type: "POST",
                data: id,
                dataType: "json",
                success : function(res){
  ...
  function detailInit(e) {
      ...
      $.ajax({
              url : '{{ url('pemeriksaan/poliumum/alergipasien') }}',
              dataType:'json',
              type:'GET',
      ...
      $.ajax({
              url : '{{ url('pemeriksaan/poliumum/asuransipasien') }}',
              dataType:'json',
              type:'GET',
              data:{'Pasien_Id' : data.Pasien_Id},
              success:function(res){
