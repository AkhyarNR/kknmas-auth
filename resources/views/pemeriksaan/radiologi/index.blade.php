      ...
      dataSource: {
        transport:{
          read : function(options) {
            ...
            $.ajax({
              url : '{{ url('pemeriksaan/radiologi/read') }}',
              type: 'GET',
              dataType: 'json',
              data: options.data,
          ...
          create : function(options) {
            $.ajax({
              ...
              url : '{{ url('pemeriksaan/radiologi/create') }}',
              type: 'POST',
              dataType: 'json',
              data: options.data,
              success: function(res) {
         ...
         $("#Pasien_Id").kendoDropDownList({
            ...
            dataSource:{
                transport:{
                    read:{
                        type: "GET",
                        url: "{{url('pemeriksaan/radiologi/getPasien')}}",
                        dataType: "json"
                    }
                }
            },
                    ...
                    actions: [
                        {
                            ...
                            action: function (e) {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{ asset('pemeriksaan/radiologi/hapus') }}",
                                    type: "GET",
                                    data: id,
                                    dataType: "json",
                      complete: function (e) {
      ...
      var RiwayatPemeriksaan = new kendo.data.DataSource({
        transport:{
          read: function(options){
            ...
            $.ajax({
              url: '{{ url('pemeriksaan/radiologi/readdetail') }}',
              type: "GET",
